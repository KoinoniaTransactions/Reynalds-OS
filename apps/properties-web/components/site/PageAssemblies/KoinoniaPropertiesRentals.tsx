  ...
  return (
    <main className="koinonia-site">
      ...
      <Hero
        ...
        lead="Current rental availability is shared here as Koinonia Properties publishes active listings."
      ...
      <section className="koinonia-section">
        <div className="koinonia-container">
          <div className="koinonia-section-header">
            ...
            <p className="koinonia-copy">There are no public listings at this time. Contact Koinonia Properties with a rental-availability question.</p>
          </div>
