...
export const metadata: Metadata = {
  ...
  alternates: { canonical: absoluteUrl("/client/transactions/new") },
  robots: { index: false, follow: false }
};

export default async function NewClientTransactionPage() {
  await requirePortalPermission("client-portal:transactions:create", "/client/transactions/new");

  return (
    <main className="koinonia-site koinonia-client-new-transaction">
      <Header />
      <section className="koinonia-section koinonia-client-new-file-hero">
        <div className="koinonia-container">
          ...
          <div className="koinonia-client-document-heading">
            ...
            <p>Contract, listing agreement, disclosure, addendum, or whatever you have right now. You do not need to organize or rename anything. Koinonia will build the file from there.</p>
          </div>
        </div>
      </section>
