...
import {
  ...
  type CreatePersonalFinanceNetWorthRecordInput
} from "../../../../lib/personal-finance-net-worth-service-local";
...
export async function POST(
  ...
  if (
    ...
    return NextResponse.json(
      {
        error:
          "Asset or liability details are required."
      },
      { status: 400 }
    );
  }
  ...
  try {
    const catalog =
      createPersonalFinanceNetWorthRecord(
        body as
          CreatePersonalFinanceNetWorthRecordInput
      );
