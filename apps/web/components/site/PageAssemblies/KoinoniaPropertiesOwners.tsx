...
const ownerFaqs = [
  ...
  {
    q: "Will Koinonia Properties publish exact fees?",
    a: "The first version should use consultation-based pricing until the management agreement, reserve policy, fee schedule, and broker requirements are finalized."
  },
  {
    q: "Can Koinonia manage more than one property?",
    a: "Yes. The portfolio path should support repeatable reporting, maintenance visibility, and consistent owner communication across multiple properties."
  }
];
  ...
  return (
    <main className="koinonia-site">
      ...
      <Hero
        ...
        secondaryHref="/properties/pricing"
      />
        ...
        <div className="koinonia-container">
          <div className="koinonia-split">
            <div>
              ...
              <h2 className="koinonia-heading">The owner promise needs operating rules behind it.</h2>
              <p>These items should be finalized before Koinonia Properties accepts public owner inquiries as an active management company.</p>
            </div>
            <ul>
