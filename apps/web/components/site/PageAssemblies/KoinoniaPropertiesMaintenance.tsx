  ...
  return (
    <main className="koinonia-site">
      ...
      <Hero
        ...
        lead="Koinonia Properties should make it easy for tenants to report issues and for owners to understand approval, cost, and status."
        primaryLabel="Tenant Portal"
        primaryHref="/properties/portals"
        ...
        <div className="koinonia-container">
          <div className="koinonia-split">
            <div>
              ...
              <p>These rules should be confirmed before Koinonia Properties accepts maintenance responsibility for managed homes.</p>
            </div>
            <ul>
