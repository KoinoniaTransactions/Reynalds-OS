export const referralsContent = {
  hero: {
    ...
    title: "Can't take the client? Keep the opportunity.",
    lead:
  ...
  whyRefer: {
    eyebrow: "Why Refer Instead of Keeping 100%?",
    title: "Some clients have real value—but not enough immediate value to justify carrying the entire relationship today.",
    lead:
    ...
    cards: [
      {
        title: "You're already carrying legitimate business",
        body:
      ...
      {
        title: "The client needs a longer runway",
        body:
      ...
      {
        title: "The buyer is not finance-ready yet",
        body:
      ...
      {
        title: "The opportunity is outside your preferred focus",
        body:
      ...
      {
        title: "You would rather know it is being worked",
        body:
  ...
  fit: {
    eyebrow: "When This Option Makes Sense",
    title: "Not every lead needs to become another client on your calendar.",
    lead:
  ...
  visibility: {
    eyebrow: "Referral Partner Visibility",
    title: "You should know the opportunity is being cared for.",
    lead:
    ...
    items: [
      ...
      "Active nurture / preparation",
      "Client transaction-ready",
      "Active search or listing activity",
      "Under contract",
      "Closing scheduled",
      "Closed / referral settlement processing"
    ]
  },
