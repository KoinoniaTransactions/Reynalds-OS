# Koinonia Service Guide Design Spec

Status: Active Design Spec  
Owner: Koinonia Transactions  
Purpose: Define the client-facing Service Guide used for consultations, brokerage follow-up, email sharing, print/PDF use, and marketing support.
...
**A Separate Path When You Don't Want to Take the Client**
...
Public benefit may state:

**40% referral fee on qualifying successfully closed referred business.**

Do not display detailed brokerage settlement mechanics, internal Koinonia deductions, or brokerage-specific compensation formulas.

Include the trust rule:
...
- restrained Koinonia gold accents
...
Do not make the Service Guide look like software marketing.

The portal may be mentioned only as a communication/visibility tool supporting service delivery. It is not a sixth service and should not become the visual or messaging focus.

## Professional Boundary

Include concise boundary language:
