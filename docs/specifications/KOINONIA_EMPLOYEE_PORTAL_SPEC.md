...
5. `/employee/access` access workspace connected to portal users and invitations, with a protected invitation form and safe sample-data fallback when storage is unavailable.
